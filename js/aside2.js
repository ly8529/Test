...
//console.info(data.Aggregations);
   ...
   /* var updateStatView = function () {
    ...
    $('.filter-title').mouseenter(function(){
        ...
        var height = $('.panel-wrap').offset().top;
        console.info(height);
    })
   ...
   /* var height = function(){
        ...
        var right_height = $('.right-filter').height();
        console.info(height);
        console.info(right_height);
        console.info(scrollHeight);
        $('.right-filter').css({top: scrollHeight+67+'px'});
        console.info($('.right-filter').css('top'));
    }
